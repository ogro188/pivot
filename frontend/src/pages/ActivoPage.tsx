...
import { fetchSignals, fetchLogs, startAsset, stopAsset, fetchHistory } from '../api'
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button onClick={() => startAsset(simbolo!)} className="bg-green-600 hover:bg-green-700 text-white px-3 py-1 rounded text-sm">Start</button>
          <button onClick={() => stopAsset(simbolo!)} className="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded text-sm">Stop</button>
        </div>
      </div>
      <div className="flex gap-2">
        {['M15', 'H1', 'H4', 'D1'].map((t) => (
